...
const PRODUCTS: Product[] = [
  { id: 1, name: "WORD IS BOND TEE", category: "TOPS", price: 68, tag: "NEW DROP", desc: "Heavyweight 340gsm cotton. Oversized cut. Screen-printed verse on chest.", sizes: ["XS","S","M","L","XL","XXL"], colors: ["#f5f0e8","#1a1a1a","#0d6e5a"], image: null },
  ...
  { id: 5, name: "REMNANT CAP", category: "ACCESSORIES", price: 48, tag: null, desc: "6-panel structured cap. Embroidered arch logo. Adjustable strap.", sizes: ["ONE SIZE"], colors: ["#1a1a1a","#f5f0e8","#0d6e5a"], image: null },
  { id: 6, name: "PILGRIM SHORTS", category: "BOTTOMS", price: 88, tag: "NEW DROP", desc: "Heavy twill. Relaxed fit. Hidden pocket with lamb's wool lining.", sizes: ["S","M","L","XL","XXL"], colors: ["#2c2418","#f5f0e8"], image: null },
];
